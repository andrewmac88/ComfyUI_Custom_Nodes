...
class SimpleGrid2x2:
    ...
    def make(self, image1, image2, image3, image4, resize_mode: str = "max", width: int = 1024, height: int = 1024):
        pils = [_tensor_to_pil(x) for x in (image1, image2, image3, image4)]
...
NODE_CLASS_MAPPINGS = {
    "SimpleGrid2x2": SimpleGrid2x2,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "SimpleGrid2x2": "Simple 2x2 Grid",
}
